...
(function ($, undefined) {
  ...
  $document.ready(function () {
    ...
    $(".main-header").imagesLoaded({ background: true }, function () {
      $(".main-header-background-square").css(
        "background-color",
        "transparent"
      );
    });
    ...
    $(".home-template .main-header-background-square").on(
      "transitionend MSTransitionEnd webkitTransitionEnd oTransitionEnd",
      function (e) {
        $(".home-template .page-title, .home-template .page-description").css(
          "display",
          "inherit"
        );
      }
  ...
  // This is a scroll functionality done by paul Adam Davis
